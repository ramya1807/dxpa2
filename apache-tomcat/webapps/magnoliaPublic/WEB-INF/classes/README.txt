...
This package contains:
   ...
   Magnolia Core 6.2.7
   Magnolia empty webapp 6.2.7
   Magnolia empty webapp 6.2.7
   Magnolia Internationalization Framework 6.2.7
   Magnolia JAAS 6.2.7
   Magnolia Mail module 5.5.7
   magnolia-module-rssaggregator 2.6.3
   Magnolia Rendering 6.2.7
   Magnolia Templating 6.2.7
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.7.html
